            ...
            size_t char_offset, size_t *entry_offset_byte_rtn )
{
    ...
    while (entries_checked < AESDCHAR_MAX_WRITE_OPERATIONS_SUPPORTED)
    {
        ...
        index = (index == (AESDCHAR_MAX_WRITE_OPERATIONS_SUPPORTED - 1)) ? 0 : (index + 1);
        ++entries_checked;
    }
    return NULL;
}
...
* @return a pointer to the memory that was overwritten, or NULL if no memory was overwritten
*/
